            ...
            <div class="widget-header-2">
                <div class="row align-self-center">
                    <div class="col-md-4 align-self-center">
                        <h4 class="widget-title">Ơn gọi Cộng đoàn</h4>
                    </div>
                                ...
                                <div class="col-md-5">
                                    <div class="post-thumb position-relative border-radius-5">
                                        <div class="img-hover-slide border-radius-5 position-relative"
                                            ...
                                            <a class="img-link" href="{{route('clients.vocation.show', [$vocation->id])}}"></a>
                                        </div>
                                ...
                                <div class="col-md-7">
                                    <div class="post-content">
                                        ...
                                        <div class="post-excerpt mb-15 text-limit-3-row font-small text-muted text-justify">
                                            <p class="mb-10 p-0">{{$vocation->community->name ?? "Khác"}}</p>
                                            <p class="m-0 p-0">{{$vocation->description}}</p>
                                        </div>
