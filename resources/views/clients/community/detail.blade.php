                    ...
                    <div class="col-lg-8 mb-30">
                        <div class="carausel-post-1 hover-up border-radius-10 overflow-hidden transition-normal position-relative wow fadeInUp animated">
                            ...
                            <div class="slide-fade">
                                @php($index = 0)
                                @for(; count($newsHot) - 6 > $index; $index++)
                                    <div class="position-relative post-thumb">
                                        <div class="thumb-overlay img-hover-slide position-relative"
                                             style="background-image: url(assets/imgs/news/news-{{$index%10 + 1}}.jpg)">
                                            ...
                                            <div class="post-content-overlay text-white p-30">
                                                <div class="entry-meta meta-0 font-small mb-20">
                                                    <a href="{{route('clients.community.show', [$newsHot[$index]->community_id])}}"><span
                                                                class="post-cat text-info text-uppercase">{{$newsHot[$index]->community->name}}</span></a>
                                                    <a href="category.html.htm"><span
                                                                class="post-cat text-success text-uppercase">Animal</span></a>
                                                </div>
                                                <h3 class="post-title font-weight-900 mb-20">
                                                    <a class="text-white"
                                                       href="{{route('clients.community.show', [$newsHot[$index]->community_id])}}">{{$newsHot[$index]->title}}</a>
                                                </h3>
                                                <div class="entry-meta meta-1 font-small text-white mt-10 pr-5 pl-5">
                                                    <span class="post-on">{{$newsHot[$index]->created_at}}</span>
