...
<!-- Copied from http://demos.alithemes.com/html/stories/demo/page-404.html by Cyotek WebCopy 1.8.0.652, Monday, September 7, 2020, 6:05:35 PM -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Stories - 404 - page not found</title>
    ...
    <div class="container">
        <div class="row pt-80">
            ...
            <div class="col-lg-6 col-md-12 pl-50 text-md-center text-lg-left">
                ...
                <p class="">The link you clicked may be broken or the page may have been removed.<br> visit the <a href="index.html.htm">Homepage</a> or <a href="page-contact.html.htm">Contact us</a> about the problem
                </p>
                <div class="form-group">
                    <button type="submit" class="button button-contactForm mt-30"><a class="text-white" href="index.html.htm">Home page</a></button>
                </div>
            </div>
        </div>
    </div>
