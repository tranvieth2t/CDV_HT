...
class News_Community_7_Seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $jsonString = file_get_contents(base_path('resources/dataOld/community_7.json'));
        ...
        foreach ($json as $key => $value) {
            if (DB::table('news')->where('title', $value['title'])->count() == 0) {
                DB::table('news')->insert([
                    ...
                    'thumbnail' => config('constants.news_thumbnail_default.7'),
